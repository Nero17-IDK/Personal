...
bool ocupado(const vector<string>& fichas, int temp){
    ...
    } else if(fichas[temp] == " X " || fichas[temp] == " O "){
        cout << "La posicion " << temp + 1 << " esta ocupada.\n";
        return true;
    } else if(validnt == true) {
        // Si la entrada es algo distinto a un valor entero desde 1 hasta 9 devuelve falso
        return true;
    } else if(over == true){
